...
<head>
    ...
    <title>BAB 5 - Aplikasi Persamaan Diferensial Orde Satu</title>
    <style>
...
<script>
    // MATERI PERSIS PDF + 10 LATIHAN SOAL (tanpa teks "menurut PDF")
    const slides = [
        ...
        { type: 'content', blocks: [ { html: `<h4>Contoh 5.3 (Pertumbuhan Eksponensial)</h4><p>Suatu populasi bakteri berkembang menurut Hukum Maltus. Mula-mula terdapat 40000 bakteri dan setelah 100 hari populasi berkembang menjadi 75000 bakteri. Tentukan jumlah populasi bakteri setelah 200 hari.</p>`, cls: '' }, { html: `\\[ \\frac{dP}{dt} = kP \\rightarrow P = Ce^{kt} \\]`, cls: 'math-block' }, { html: `t = 0, P = 40000 → \\( C = 40000 \\)`, cls: '' }, { html: `t = 100, P = 75000 → \\( 75000 = 40000 e^{100k} \\rightarrow e^{100k} = 1,875 \\rightarrow k = \\frac{\\ln 1,875}{100} \\)`, cls: '' }, { html: `t = 200 → \\( P(200) = 40000 e^{200k} = 40000 \\cdot (1,875)^2 = 40000 \\cdot 3,515625 = 140625 \\)`, cls: 'math-block' } ] },
        ...
        // 10 Latihan Soal
        { type: 'exercise_num', title: 'Latihan Soal 1: Besi Panas', question: 'Sebuah besi yang memiliki temperatur 200°C dicelupkan dalam air yang memiliki temperatur tetap sebesar 40°C. Temperatur benda turun dari 200°C menjadi 150°C selama 5 detik. Berapa waktu yang dibutuhkan agar temperatur besi menjadi 100°C? (Gunakan model \\( T(t)=40+160e^{-kt} \\))', correct: 13.1, tolerance: 0.2, unit: 'detik' },
        { type: 'exercise_pop', title: 'Latihan Soal 2: Penduduk Dunia', question: 'Jumlah penduduk dunia pada tahun 1990 adalah 4.5 milyar dan bertambah secara eksponensial dengan konstanta \\( C = \\frac{\\ln 3}{8} \\). a. Berapa perkiraan jumlah penduduk dunia pada tahun 2012? b. Berapa perkiraan pada tahun 2016? (Jawab dalam milyar, dua desimal)', correctA: 92.34, correctB: 159.9, tolerance: 0.5 },
        { type: 'mcq', question: 'Hukum pendinginan Newton menyatakan laju perubahan suhu benda sebanding dengan...', options: ['Suhu benda itu sendiri', 'Selisih suhu benda dengan suhu lingkungan', 'Kuadrat suhu benda', 'Suhu lingkungan saja'], correct: 1 },
        { type: 'mcq', question: 'Solusi umum dari persamaan peluruhan radioaktif \\( \\frac{dN}{dt} = -kN \\) adalah...', options: ['\\( N(t) = N_0 e^{kt} \\)', '\\( N(t) = N_0 e^{-kt} \\)', '\\( N(t) = N_0 + kt \\)', '\\( N(t) = \\frac{N_0}{1+kt} \\)'], correct: 1 },
        ...
        { type: 'exercise_num', title: 'Latihan Soal 3: Konstanta Pendinginan', question: 'Sebuah benda bersuhu 100°C ditempatkan di ruang bersuhu 20°C. Setelah 10 menit suhu benda menjadi 60°C. Hitung konstanta k (dalam 1/menit, 3 desimal, dengan tanda negatif). Petunjuk: \\( T(t)=20+80e^{kt} \\).', correct: -0.0693, tolerance: 0.001, unit: '' },
        { type: 'exercise_num', title: 'Latihan Soal 4: Waktu Paruh', question: 'Suatu zat radioaktif memiliki waktu paruh 50 tahun. Berapa persen zat yang tersisa setelah 150 tahun? (Jawab dalam persen, bulatkan ke bilangan bulat)', correct: 12.5, tolerance: 0.5, unit: '%' },
        { type: 'mcq', question: 'Jika populasi bakteri berlipat ganda setiap 3 jam, dan awalnya 1000 bakteri, berapa jumlah setelah 9 jam?', options: ['3000', '6000', '8000', '10000'], correct: 2 },
        { type: 'exercise_num', title: 'Latihan Soal 5: Pendinginan Kopi', question: 'Kopi bersuhu 95°C diletakkan di ruang 25°C. Jika konstanta pendinginan k = 0,15 per menit, berapa menit waktu yang diperlukan agar suhu kopi menjadi 40°C? (Gunakan \\( T(t)=25+70e^{-0,15t} \\))', correct: 10.27, tolerance: 0.1, unit: 'menit' },
        { type: 'mcq', question: 'Model matematika untuk Hukum Maltus adalah...', options: ['\\( \\frac{dP}{dt} = -kP \\)', '\\( \\frac{dP}{dt} = kP \\)', '\\( \\frac{dP}{dt} = k \\)', '\\( \\frac{dP}{dt} = \\frac{k}{P} \\)'], correct: 1 },
    ...
    // State dan fungsi render (sama seperti sebelumnya)
